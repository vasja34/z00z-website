---
description: 'Module-level reference for the Dataverse SDK for Python package structure, public imports, client entry points, and core error and config types.'
applyTo: '**'
---
