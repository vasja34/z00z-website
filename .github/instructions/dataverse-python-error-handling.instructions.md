---
description: 'Error handling and troubleshooting guidance for the Dataverse SDK for Python, including transient failures, retries, diagnostics, and recovery patterns.'
applyTo: '**'
---
