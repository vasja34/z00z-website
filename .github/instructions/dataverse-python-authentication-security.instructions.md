---
description: 'Authentication and security guidance for the Dataverse SDK for Python, covering Azure Identity credential selection, secret handling, and least-privilege access.'
applyTo: '**'
---
