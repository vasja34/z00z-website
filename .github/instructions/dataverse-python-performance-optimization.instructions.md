---
description: 'Performance optimization guidance for the Dataverse SDK for Python, including query shaping, batching, pagination, retries, and memory-efficient processing.'
applyTo: '**'
---
