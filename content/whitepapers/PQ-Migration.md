...
| --- | --- | --- |
| `Z00Z-Main-Whitepaper.md` | Shipped crypto boundary, `AssetLeaf`, `EncPack`, stealth, range-proof, domain, checkpoint, and replay language | That the current system is already post-quantum secure |
...
| `Z00Z-Corpus-Terminology-Reference.md` | Shared naming and scope rules | New migration nouns that conflict with corpus terms |
